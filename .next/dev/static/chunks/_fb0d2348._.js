...
"[project]/lib/parse-helpers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function resolvePartner(row, fileName, explicitPartner) {
    ...
    const detected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["detectPartner"])(row);
...
function parseProtectRow(row, fileName, partner) {
    const dpd = normalizeNumber(getColumnValue(row, [
        "dpd",
        "days past due",
        "delay"
    ]));
    const currentDpd = normalizeNumber(getColumnValue(row, [
        "current dpd",
        "curr dpd",
        "current_dpd",
        "cur dpd"
    ...
    return {
        ...
        nexusPurchaseDate: normalizeDate(getColumnValue(row, [
            "timestamp",
            "nexus purchase date",
            "nexus_purchase_date",
            "purchase date",
        ...
        formFilledDate: normalizeDate(getColumnValue(row, [
            "form filled date",
            "form_filled_date",
            "filled date",
            "date",
        ...
        dpd,
        currentDpd,
        dpdGroup: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDPDGroup"])(currentDpd),
        status: "new",
...
function parseSettlementRow(row, fileName, partner) {
    return {
        ...
        dueAmt: normalizeNumber(getColumnValue(row, [
            "due amount",
            "due amt",
            "total due",
            "outstanding"
        ...
        currEmployment: String(getColumnValue(row, [
            "current employment",
            "curr employment",
            "employment",
            "occupation"
...
function parseNexusRow(row, fileName, partner) {
    return {
        ...
        formFilledDate: normalizeOptionalDate(getColumnValue(row, [
            "form filled date",
            "form_filled_date",
            "filled date",
            "date",
...
"[project]/components/excel-upload.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/store.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parse$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/parse-helpers.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils.ts [app-client] (ecmascript)");
...
function ExcelUpload() {
    ...
    const [detectedType, setDetectedType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("protect");
    const [selectedPartner, setSelectedPartner] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("auto");
    const { addRecords, setDateFilterType, setDateRange, setStatusFilter, setPartnerFilter, setDpdGroupFilter, setSearchQuery, setTypeFilter } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCRMStore"])();
    const validateRow = (row, type)=>{
        const errors = [];
        const name = String((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parse$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumnValue"])(row, [
            "name",
            "customer name",
            "client name",
            "cust name",
        ...
        const mobile = String((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parse$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumnValue"])(row, [
            "mobile",
            "mobile number",
            "phone",
            "contact",
        ...
        if (type === "nexus") {
            const email = String((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parse$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumnValue"])(row, [
                "email",
                "email id",
                "mail"
            ]) || "").trim();
            const userId = String((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parse$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColumnValue"])(row, [
                "user id",
                "userid",
                "id"
            ]) || "").trim();
    ...
    const onDrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ExcelUpload.useCallback[onDrop]": (acceptedFiles)=>{
            ...
            reader.onload = ({
                "ExcelUpload.useCallback[onDrop]": (e)=>{
                    try {
                        ...
                        if (jsonData.length > 0) {
                            ...
                            setColumns(cols);
                            const type = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["detectRecordType"])(cols);
                            setDetectedType(type);
                            const validated = jsonData.map({
                                "ExcelUpload.useCallback[onDrop].validated": (row)=>validateRow(row, type)
                            }["ExcelUpload.useCallback[onDrop].validated"]);
            ...
            })["ExcelUpload.useCallback[onDrop]"];
    ...
    const handleImport = ()=>{
        ...
        const newRecords = validRows.map((row)=>{
            if (detectedType === "protect") {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parse$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseProtectRow"])(row.data, fileName, partnerToPass);
            } else if (detectedType === "settlement") {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parse$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseSettlementRow"])(row.data, fileName, partnerToPass);
            } else {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$parse$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNexusRow"])(row.data, fileName, partnerToPass);
            }
        });
        const uploadRecord = {
            id: `upload-${Date.now()}`,
    ...
    const downloadProtectTemplate = ()=>{
        const template = [
            {
                "Nexus Purchase Date": "2024-01-15",
                "Form Filled Date": "2024-01-20",
                Name: "John Doe",
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].book_append_sheet(wb, ws, "Protect Template");
        ...
        const template = [
            {
                ...
                Name: "Jane Doe",
                "Mobile Number": "9876543210",
                "Lender Name": "HDFC Credit Cards",
                "Credit Card No": "XXXX-XXXX-XXXX-1234",
                "Loan Acc No": "CC123456789",
                "Due Amt": 85000,
                "Due Date": "2024-02-28",
                "Is EMI Bounced": "No",
                "Is Legal Notice": "No",
                "Curr Employment": "Private Sector",
                "Recommended Amt": 51000,
                "Customer Wish Amt": 45000
            }
        ];
        const ws = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].json_to_sheet(template);
        const wb = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].book_new();
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].book_append_sheet(wb, ws, "Settlement Template");
        const wbout = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["write"](wb, {
            bookType: "xlsx",
            type: "array"
        });
        ...
        const template = [
            {
                ...
                "Form Filled": "2024-03-15"
            }
        ];
        const ws = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].json_to_sheet(template);
        const wb = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].book_new();
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].book_append_sheet(wb, ws, "Nexus Template");
        const wbout = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["write"](wb, {
            bookType: "xlsx",
            type: "array"
        });
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                isProcessing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    lineNumber: 296,
                                    columnNumber: 15
                                }, this) : uploadSuccess ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex flex-col items-center gap-3",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                            children: parsedData.slice(0, 20).map((row, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("hover:bg-muted/20", !row.valid && "bg-red-500/5"),
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: row.errors.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            parsedData.length > 20 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(ExcelUpload, "AgXlArmoofnIHEVaE3KTxaxysoI=", false, function() {
    return [
...
_c = ExcelUpload;
var _c;
__turbopack_context__.k.register(_c, "ExcelUpload");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$excel$2d$upload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/excel-upload.tsx [app-client] (ecmascript)");
"use client";
;
;
;
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "p-6",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$excel$2d$upload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ExcelUpload"], {}, void 0, false, {
                            fileName: "[project]/app/upload/page.tsx",
                            lineNumber: 16,
                            columnNumber: 11
                        }, this)
...
//# sourceMappingURL=_fb0d2348._.js.map