...
"[project]/app/nexus-purchased/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NexusPurchasedPage() {
    _s();
    const { records, setRecords, deleteRecord, deleteRecords, isInitialized, setInitialized, hasHydrated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCRMStore"])();
    // Local filter state
            ...
            if (hasHydrated && !isInitialized) {
                if (records.length === 0) {
                    setRecords([
                        ...
                        ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sample$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sampleNexusRecords"]
                    ]);
                } else {
                    // Check if Nexus records are missing from existing records (e.g. if loaded from local storage before update)
                    const hasNexus = records.some({
                        "NexusPurchasedPage.useEffect.hasNexus": (r)=>r.type === "nexus"
                    }["NexusPurchasedPage.useEffect.hasNexus"]);
                    if (!hasNexus) {
                        setRecords([
                            ...records,
                            ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sample$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sampleNexusRecords"]
    ...
    // Use Nexus records
    // Use Nexus records
    const nexusRecords = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NexusPurchasedPage.useMemo[nexusRecords]": ()=>records.filter({
                "NexusPurchasedPage.useMemo[nexusRecords]": (r)=>r.type === "nexus"
            }["NexusPurchasedPage.useMemo[nexusRecords]"])
    }["NexusPurchasedPage.useMemo[nexusRecords]"], [
        records
    ]);
    const filteredRecords = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NexusPurchasedPage.useMemo[filteredRecords]": ()=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterRecords"])(nexusRecords, {
                searchQuery,
                statusFilter,
                partnerFilter,
                dateRangeStart,
...
_s(NexusPurchasedPage, "qSbsjn1hlvYqV7WsxBO3HVGA1+I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCRMStore"]
    ];
});
_c = NexusPurchasedPage;
var _c;
__turbopack_context__.k.register(_c, "NexusPurchasedPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_68a2b52c._.js.map